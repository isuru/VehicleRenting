...
public class VehicleManagementView extends javax.swing.JFrame {
    ...
    private void loadAllVehicles() {
        ResultSet rs = VehicleController.loadAllVehicles(filterStatus);
    ...
    private void initComponents() {
        ...
        cboStatus.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "All", "Available", "Reserved" }));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(cboStatus, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        HashMap<String,String> details = VehicleController.getVehicleDetais(vehicleNo);
        
        cboType.setSelectedItem(details.get("type"));
        txtVehicleNo.setText(details.get("vehicle_no"));
        txtMileage.setText(details.get("mileage"));
        txtMake.setText(details.get("make"));
        txtModel.setText(details.get("model"));
        txtYear.setText(details.get("year"));
        txtEngineNo.setText(details.get("engine_no"));
        txtChassisNo.setText(details.get("chassis_no"));
        txtOwnerName.setText(details.get("owner_name"));
        txtOwnerTel.setText(details.get("owner_tel"));
        txtOwnerAddress.setText(details.get("owner_address"));
        txtDailyRent.setText(details.get("daily_rent"));
        txtWeeklyRent.setText(details.get("weekly_rent"));
        txtMonthlyRent.setText(details.get("monthly_rent"));
        saveMode = "EDIT";
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(this, "Are you sure, you want to delete the Vehicle?\n\nVehicle No: " + vehicleNo, "Delete Vehicle", JOptionPane.YES_NO_OPTION)==JOptionPane.YES_OPTION) {        
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (saveMode.equals("NEW") && VehicleController.addNewVechicle(params)) {
        ...
        } else if (saveMode.equals("EDIT") && VehicleController.updateVechicle(params)) {
            JOptionPane.showConfirmDialog(this, "Vehicle updated successfully", "Edit Vehicle", JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE);            
            this.loadAllVehicles();
            
        } else {
            JOptionPane.showConfirmDialog(this, "Failed to save vehicle.\n\nError: " + VehicleController.ERROR_MESSAGE, "Save Vehicle", JOptionPane.DEFAULT_OPTION, JOptionPane.ERROR_MESSAGE);
        }
